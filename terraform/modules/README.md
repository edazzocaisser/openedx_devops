...
Note that **you do not execute any of these Terraform scripts directly**. Quite the contrary, each of these modules is wired to its Terragrunt counterpart located in [terraform/environments/live](terraform/environments/live) and is called by Terragrunt.
